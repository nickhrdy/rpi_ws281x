...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--color', nargs=3, type=int, help='specify a specific RGB color e.g. 255 255 255')
    ...
    try:
        if args.color:
            single_color(strip, Color(*args.color))
        else:
            single_color(strip, Color(255, 0, 0))
        # while True:
